    ...
    <div @click="present">
      ...
      <svg xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" style="margin: 0 auto"
        ...
        <g fill-rule="evenodd" fill="none" stroke-width="1" stroke="none" id="页面-1">
          <g transform="translate(-209.000000, -289.000000)" id="画板">
            <g transform="translate(209.000000, 289.000000)" id="编组-5">
              <g transform="translate(76.000000, 25.900578)" id="编组-40">
                <ellipse ry="11" rx="10" cy="56" cx="85" stroke-width="4" stroke="#E4E6E9" id="椭圆形"></ellipse>
                <g transform="translate(0.000000, 38.000000)" id="椭圆形备份-17">
                  <mask fill="white" id="mask-3">
                    <use xlink:href="#path-2"></use>
                  </mask>
                  <use xlink:href="#path-2" fill="url(#linearGradient-1)" id="蒙版"></use>
                </g>
                <rect rx="3" height="6" width="80" y="92" x="5" fill="#E4E6E9" id="矩形"></rect>
                <rect rx="2" height="24" width="4" y="10" x="22" fill="url(#linearGradient-4)" id="矩形备份-18"></rect>
                <rect rx="2" height="34" width="4" y="0" x="41" fill="url(#linearGradient-5)" id="矩形备份-19"></rect>
                <rect rx="2" height="24" width="4" y="10" x="60" fill="url(#linearGradient-6)" id="矩形备份-20"></rect>
              </g>
            </g>
          </g>
        </g>
