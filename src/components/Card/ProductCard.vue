    ...
    <el-card shadow="always" class="product" @click.stop="ClickCard()">
      ...
      <div class="description">
        <div style="width: 100%; margin-top: 0;">
          <div class="like" v-show="props.showLike">
            <span class="title">{{ props.product.name }}</span>
            <svg t="1649653878259" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
            ...
            <svg t="1649655278002" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
